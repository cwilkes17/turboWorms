...
- `bounced` — whether this fireball has bounced off a shield. Still lethal
  (PRODUCT.md), just on the shorter `FIREBALL_BOUNCE_RANGE_PX` budget instead
